...
async function run() {
  ...
  const profiles = [
    { id: '00000000-0000-0000-0000-000000000001', email: userEmail, full_name: 'Demo User', role: 'user', is_admin: false, can_post: false },
    { id: '00000000-0000-0000-0000-000000000002', email: newUserEmail, full_name: 'New User', role: 'user', is_admin: false, can_post: false },

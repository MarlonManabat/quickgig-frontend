...
export default function PayPage() {
  ...
  return (
    <main className="max-w-xl mx-auto p-6 space-y-6">
      ...
      <p>
        Tickets cost ₱{TICKET_PRICE_PHP} each. You received{" "}
        {FREE_TICKETS_ON_SIGNUP} free tickets on signup. Current balance:{" "}
        {balance}.
      </p>
